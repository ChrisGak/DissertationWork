 ...
 * Created by Chris
 */
public class RungeKuttaMethodResult implements IsSerializable {
     ...
     * 8 - номер итерации
     */
    public RungeKuttaMethodResult(Vector time, Vector tetta, Vector omega, Vector eps, Vector A, Vector ex, Vector step, Vector accuracy, Vector iter) {
    ...
    public static void printResultsToConsole(RungeKuttaMethodResult result) {
        /**
         * Мапа векторов расчитанных значений
         * 0 - время
         * 1 - тетта
    ...
    public static void printFirstAndLastResults(RungeKuttaMethodResult result) {
        /**
         * Мапа векторов расчитанных значений
         * 0 - время
         * 1 - тетта
    ...
    public static void printResultsWithSignsToConsole(RungeKuttaMethodResult result, int signes) {
        /**
         * Мапа векторов расчитанных значений
         * 0 - время
         * 1 - тетта
