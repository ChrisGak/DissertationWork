...
public class ExcelWritter {
    ...
    public void writeRungeKuttaResult(OrbitalElements result) throws IOException, WriteException {
        int col_start = 0;
        int row_start = 3;
        int col_step = 2;
        ...
        addOneDoubleVector(excelSheet1, result.getTetherVerticalDeflectionAngle(), col_start, row_start + 1);

        col_start += col_step;
        addLabel(excelSheet1, col_start, row_start, "Omega");
        addOneDoubleVector(excelSheet1, result.getTetherVerticalDeflectionAngleDiff(), col_start, row_start + 1);

        col_start += col_step;
        addLabel(excelSheet1, col_start, row_start, "Eps");
        addOneDoubleVector(excelSheet1, result.getTrueAnomaly(), col_start, row_start + 1);

        col_start += col_step;
        addLabel(excelSheet1, col_start, row_start, "A");
        addOneDoubleVector(excelSheet1, result.getSemimajorAxis(), col_start, row_start + 1);

        col_start += col_step;
        addLabel(excelSheet1, col_start, row_start, "Ex");
        addOneDoubleVector(excelSheet1, result.getEccentricity(), col_start, row_start + 1);
        ...
        addOneIntegerVector(excelSheet1, result.getIteration(), col_start, row_start + 1);
    ...
    public void writeFullInfo(ElectrodynamicTetherSystemModel model, OrbitalElements result) throws IOException, WriteException {
        int col_start = 0;
        int row_start = 3;
        int col_step = 2;
        int row_first = 1;
        ...
        addNumber(excelSheet, col_start, ++row_first, model.getMainSatelliteMass());

        addLabel(excelSheet, col_start, ++row_first, "Mass2");
        addNumber(excelSheet, col_start, ++row_first, model.getNanoSatelliteMass());

//        addLabel(excelSheet, col_start, ++row_first, "L1");
//        addNumber(excelSheet, col_start, ++row_first, model.getTether());
//
...
//        addNumber(excelSheet, col_start, ++row_first, model.get());
//
...
//        addNumber(excelSheet, col_start, ++row_first, model.getI());
        ...
        addCaption(excelSheet1, col_start, 1, "Results");
        addLabel(excelSheet1, col_start, row_start, "Tetta");
        addOneDoubleVector(excelSheet1, result.getTetherVerticalDeflectionAngleDegrees(), col_start, row_start + 1);
        ...
        col_start += col_step;
        addLabel(excelSheet1, col_start, row_start, "Eps");
        addOneDoubleVector(excelSheet1, result.getTrueAnomalyDegrees(), col_start, row_start + 1);
